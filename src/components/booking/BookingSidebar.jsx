  ...
  return (
    <div className="w-full md:w-1/3 bg-[#6332E3] p-8 text-white flex flex-col gap-8">
      ...
      <div className="mt-auto space-y-6">
        <FeatureItem  title="60 Minute Session" desc="Deep dive into your topic" />
        <FeatureItem  title="Secure Video Call" desc="HD quality with PeerJS" />
        <FeatureItem  title="Expert Mentorship" desc={`${teacher.totalReviews}+ successful sessions`} />
      </div>
    </div>
  )
}
