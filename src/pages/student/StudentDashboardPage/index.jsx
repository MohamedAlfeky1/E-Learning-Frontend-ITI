      ...
      <div className="col-span-4">
        <div className="bg-gradient-to-tr from-[#3525CD] to-[#712AE2] rounded-2xl pt-10 pb-16 px-7">
          <h1 className="text-3xl font-extrabold text-white">
            Welcom Back, {userData.firstName}!
          </h1>
          <p className="text-gray-300 font-light text-xs">
            You've completed{" "}
            <span className="text-white">{averageProgress}%</span> of your
            weekly goals. Keep the momentum <br />
        ...
        <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  <div className="flex flex-col  gap-3 p-4 w-full">
                    ...
                    <div className="flex gap-3 mt-1">
                      <Button
                        onClick={() =>
                          navigate(`/my-courses/${course?.courseId?._id}/learn`)
                        }
          ...
          <div className="flex flex-col md:flex-row gap-3 rounded-md flex-1">
            {enrollments?.slice(1, 3).map((course) => {
              return (
                <Link
                  to={`/my-courses/${course._id}/learn`}
                  className="p-3 bg-gray-200 rounded-md w-full flex flex-col gap-3 items-start justify-center"
                >
                  ...
                  {course.completed == "false" ? (
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      {course.progress > 0 ? (
                        ...
                        <div className="bg-gray-400 h-2 rounded-full transition-all duration-500 w-full" />
                      )}
                    </div>
                  ) : (
                    <div className="w-full bg-gray-200 rounded-full h-2">
            ...
            {bookings?.length === 0 ? (
              ...
              <div className="flex flex-col gap-3">
                {bookings?.map((booking) => {
                  ...
                  const [startHour, startMin] = booking.scheduledTime
                    .split(":")
                    .map(Number);
                  ...
                  return (
                    <div key={booking._id} className="flex gap-4 items-start">
                      ...
                      <div className="flex flex-col items-center min-w-[40px]">
                        ...
                        <div
                          className={`w-1.5 h-1.5 rounded-full mt-1 ${statusColor}`}
                        />
                      </div>
